...
a little hint for u 
 ...
 C- CREATE   add     [...products, product]           post
 R- READ     get     map                              get
 U- UPDATE   edit    find    product.name = name      patch, put
 D- DELETE   delete  filter                           delete

install this:
    npx json-server db.json
    
so firstly you need to make a db.jdon file
{
  "apps": [
    {
      "name": "hnhn",
